...
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "init" -d 'Scaffold a new DKP pack directory with all required files'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "info" -d 'Print a summary of a pack (name, version, asset counts, compliance)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "list" -d 'List all packs under a root directory'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "validate" -d 'Run schema and compliance checks; exit non-zero on failure'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "search" -d 'Full-text BM25 search across machine assets (or registry with --registry)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "get" -d 'Retrieve a specific asset or all assets of a type'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "inject" -d 'Print a ready-to-inject LLM context block'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "export" -d 'Convert machine assets to another format (okf, langchain, llamaindex, …)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "okf" -d 'OKF-specific operations (export, validate, stats, links, browse)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "chunk" -d 'Retrieve the top-N most relevant retrieval chunks for a query'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "eval" -d 'Run eval set against baseline and grounded prompts; print delta report'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "prompt" -d 'Interactive grounded prompt REPL for testing a pack'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "diff" -d 'Compare two pack versions and report what changed'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "build" -d 'Package a pack into a versioned archive with checksums.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "release-check" -d 'Pre-release compliance checklist (runs all gates, checks human fields)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "rights" -d 'Source and rights log operations'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "mcp-manifest" -d 'Generate or regenerate machine/mcp_manifest.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "serve" -d 'Start the pack as an MCP server (requires --features mcp)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "tui" -d 'Interactive TUI browser (requires --features tui)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "webui" -d 'Browse a pack in a local web UI (requires --features webui)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "run" -d 'Invoke a WASM/WASI procedure from machine/procedures/'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "procedures" -d 'List, validate, and scaffold executable procedures'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "graph" -d 'Inspect and validate knowledge_graph.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "cross-refs" -d 'Inspect and validate cross_refs.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "skills" -d 'Manage and validate the skills/ layer'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "l10n" -d 'Manage and validate the l10n/ localization layer'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "new" -d 'Scaffold + LLM-generate a complete pack in one command'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "generate" -d 'Run (or re-run) LLM generation on an existing pack'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "fix" -d 'Failure-aware chunk regeneration using eval results'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "review" -d 'Generate evidence drafts for manual review gates'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "keygen" -d 'Generate an Ed25519 keypair for signing packs'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "sign" -d 'Sign a built archive with an Ed25519 private key'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "install" -d 'Install a pack from the registry'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "uninstall" -d 'Remove an installed pack'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "update" -d 'Re-resolve and update installed packs to satisfy lock-file constraints'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "publish" -d 'Publish a built and signed pack to the registry'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "yank" -d 'Mark a published version as yanked'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "deprecate" -d 'Mark a published version as deprecated (or clear a prior deprecation with --undo)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "registry" -d 'Registry account and pack management (login, logout, keys, access)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff build release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix review keygen sign install uninstall update publish yank deprecate registry help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
