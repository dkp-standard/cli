...
complete -c dkp -n "__fish_dkp_needs_command" -f -a "version" -d 'Bump a pack\'s manifest.json version (patch/minor/major/etc., npm-version-style)'
complete -c dkp -n "__fish_dkp_needs_command" -f -a "build" -d 'Package a pack into a versioned archive with checksums.json'
complete -c dkp -n "__fish_dkp_needs_command" -f -a "render-handbook" -d 'Render human/handbook.md to handbook.pdf/handbook.epub (spec §11.2)'
...
complete -c dkp -n "__fish_dkp_needs_command" -f -a "fix-until" -d 'Iterative eval+fix loop until a pass-rate threshold is met'
...
complete -c dkp -n "__fish_dkp_needs_command" -f -a "deprecate" -d 'Mark a published version as deprecated (or clear a prior deprecation with --undo)'
...
complete -c dkp -n "__fish_dkp_using_subcommand version" -s m -l message -d 'Commit message template; %s is replaced with the new version' -r
complete -c dkp -n "__fish_dkp_using_subcommand version" -l output -d 'Output format' -r -f -a "plain\t'Human-readable plain text (default)'
table\t'Aligned table using comfy-table'
json\t'Pretty-printed JSON'"
complete -c dkp -n "__fish_dkp_using_subcommand version" -l audience -d 'Filter content to assets tagged for a specific audience profile' -r
complete -c dkp -n "__fish_dkp_using_subcommand version" -l no-git-tag-version -d 'Skip git commit/tag even if the pack is inside a git repository'
complete -c dkp -n "__fish_dkp_using_subcommand version" -l allow-same-version -d 'Allow bumping to the same version as the current one'
complete -c dkp -n "__fish_dkp_using_subcommand version" -s q -l quiet -d 'Suppress informational output; print only results'
complete -c dkp -n "__fish_dkp_using_subcommand version" -s v -l verbose -d 'Print debug info (schema paths, provider calls, etc.)'
complete -c dkp -n "__fish_dkp_using_subcommand version" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c dkp -n "__fish_dkp_using_subcommand version" -s V -l version -d 'Print version'
...
complete -c dkp -n "__fish_dkp_using_subcommand build" -l render-handbook -d 'Render human/handbook.md to handbook.pdf/handbook.epub before packaging, if missing or older than handbook.md'
...
complete -c dkp -n "__fish_dkp_using_subcommand render-handbook" -l output -d 'Output format' -r -f -a "plain\t'Human-readable plain text (default)'
table\t'Aligned table using comfy-table'
json\t'Pretty-printed JSON'"
complete -c dkp -n "__fish_dkp_using_subcommand render-handbook" -l audience -d 'Filter content to assets tagged for a specific audience profile' -r
complete -c dkp -n "__fish_dkp_using_subcommand render-handbook" -s q -l quiet -d 'Suppress informational output; print only results'
complete -c dkp -n "__fish_dkp_using_subcommand render-handbook" -s v -l verbose -d 'Print debug info (schema paths, provider calls, etc.)'
complete -c dkp -n "__fish_dkp_using_subcommand render-handbook" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c dkp -n "__fish_dkp_using_subcommand render-handbook" -s V -l version -d 'Print version'
...
complete -c dkp -n "__fish_dkp_using_subcommand rights; and __fish_seen_subcommand_from add-source" -l from-discovered -d 'Promote entries from build/sources_discovered.jsonl instead of prompting for a brand-new source from scratch'
...
complete -c dkp -n "__fish_dkp_using_subcommand new" -l instructions -d 'Extra free-text guidance appended to every generation prompt (e.g. tone, focus areas, things to emphasize or avoid)' -r
complete -c dkp -n "__fish_dkp_using_subcommand new" -l max-tool-turns -d 'Max tool round-trips per generation call before giving up (default: 6)' -r
...
complete -c dkp -n "__fish_dkp_using_subcommand new" -l no-tools -d 'Disable web_fetch/web_search tool use (on by default)'
complete -c dkp -n "__fish_dkp_using_subcommand new" -l no-render-formats -d 'Skip rendering human/handbook.md to handbook.pdf/handbook.epub (on by default)'
...
complete -c dkp -n "__fish_dkp_using_subcommand generate" -l instructions -d 'Extra free-text guidance appended to every generation prompt (e.g. tone, focus areas, things to emphasize or avoid)' -r
complete -c dkp -n "__fish_dkp_using_subcommand generate" -l max-tool-turns -d 'Max tool round-trips per generation call before giving up (default: 6)' -r
...
complete -c dkp -n "__fish_dkp_using_subcommand generate" -l no-tools -d 'Disable web_fetch/web_search tool use (on by default)'
complete -c dkp -n "__fish_dkp_using_subcommand generate" -l no-render-formats -d 'Skip rendering human/handbook.md to handbook.pdf/handbook.epub (on by default)'
...
complete -c dkp -n "__fish_dkp_using_subcommand fix" -l instructions -d 'Extra free-text guidance appended to every generation prompt (e.g. tone, focus areas, things to emphasize or avoid)' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix" -l max-tool-turns -d 'Max tool round-trips per generation call before giving up (default: 6)' -r
...
complete -c dkp -n "__fish_dkp_using_subcommand fix" -l no-tools -d 'Disable web_fetch/web_search tool use (on by default)'
complete -c dkp -n "__fish_dkp_using_subcommand fix" -l no-render-formats -d 'Skip rendering human/handbook.md to handbook.pdf/handbook.epub (on by default)'
...
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l api-key -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l base-url -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l model -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l instructions -d 'Extra free-text guidance appended to every generation prompt' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l max-tool-turns -d 'Max tool round-trips per generation call before giving up (default: 6)' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l threshold -d 'Target pass rate to stop at (0.0–1.0). Defaults to min_eval_delta from the manifest, or 1.0 if unset' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l max-rounds -d 'Maximum eval+fix rounds before giving up (default: 5)' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l pairs -d 'Run only first N eval pairs per round (default: all)' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l output -d 'Output format' -r -f -a "plain\t'Human-readable plain text (default)'
table\t'Aligned table using comfy-table'
json\t'Pretty-printed JSON'"
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l audience -d 'Filter content to assets tagged for a specific audience profile' -r
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l no-tools -d 'Disable web_fetch/web_search tool use (on by default)'
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l no-render-formats -d 'Skip rendering human/handbook.md to handbook.pdf/handbook.epub (on by default)'
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -l baseline-only -d 'Score without DKP context (baseline only)'
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -s q -l quiet -d 'Suppress informational output; print only results'
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -s v -l verbose -d 'Print debug info (schema paths, provider calls, etc.)'
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c dkp -n "__fish_dkp_using_subcommand fix-until" -s V -l version -d 'Print version'
complete -c dkp -n "__fish_dkp_using_subcommand review" -l api-key -r
complete -c dkp -n "__fish_dkp_using_subcommand review" -l base-url -r
complete -c dkp -n "__fish_dkp_using_subcommand review" -l model -r
...
complete -c dkp -n "__fish_dkp_using_subcommand review" -l no-citations -d 'Skip the citation-checking pass even if an API key and discovered sources are available'
...
complete -c dkp -n "__fish_dkp_using_subcommand install" -l accept-new-key -d 'Accept a publisher\'s signing key even if it differs from the previously pinned key (lockfile and/or ~/.dkp/trusted_keys.json). Only pass this after verifying the key rotation out-of-band'
...
complete -c dkp -n "__fish_dkp_using_subcommand update" -l accept-new-key -d 'Accept a publisher\'s signing key even if it differs from the previously pinned key. Only pass this after verifying the key rotation out-of-band'
...
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -l message -d 'Message shown to consumers who install this version (required unless --undo)' -r
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -l token -d 'Registry API token' -r
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -l output -d 'Output format' -r -f -a "plain\t'Human-readable plain text (default)'
table\t'Aligned table using comfy-table'
json\t'Pretty-printed JSON'"
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -l audience -d 'Filter content to assets tagged for a specific audience profile' -r
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -l undo -d 'Clear a previous deprecation'
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -s q -l quiet -d 'Suppress informational output; print only results'
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -s v -l verbose -d 'Print debug info (schema paths, provider calls, etc.)'
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c dkp -n "__fish_dkp_using_subcommand deprecate" -s V -l version -d 'Print version'
...
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "init" -d 'Scaffold a new DKP pack directory with all required files'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "info" -d 'Print a summary of a pack (name, version, asset counts, compliance)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "list" -d 'List all packs under a root directory'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "validate" -d 'Run schema and compliance checks; exit non-zero on failure'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "search" -d 'Full-text BM25 search across machine assets (or registry with --registry)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "get" -d 'Retrieve a specific asset or all assets of a type'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "inject" -d 'Print a ready-to-inject LLM context block'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "export" -d 'Convert machine assets to another format (okf, langchain, llamaindex, …)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "okf" -d 'OKF-specific operations (export, validate, stats, links, browse)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "chunk" -d 'Retrieve the top-N most relevant retrieval chunks for a query'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "eval" -d 'Run eval set against baseline and grounded prompts; print delta report'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "prompt" -d 'Interactive grounded prompt REPL for testing a pack'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "diff" -d 'Compare two pack versions and report what changed'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "version" -d 'Bump a pack\'s manifest.json version (patch/minor/major/etc., npm-version-style)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "build" -d 'Package a pack into a versioned archive with checksums.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "render-handbook" -d 'Render human/handbook.md to handbook.pdf/handbook.epub (spec §11.2)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "release-check" -d 'Pre-release compliance checklist (runs all gates, checks human fields)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "rights" -d 'Source and rights log operations'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "mcp-manifest" -d 'Generate or regenerate machine/mcp_manifest.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "serve" -d 'Start the pack as an MCP server (requires --features mcp)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "tui" -d 'Interactive TUI browser (requires --features tui)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "webui" -d 'Browse a pack in a local web UI (requires --features webui)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "run" -d 'Invoke a WASM/WASI procedure from machine/procedures/'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "procedures" -d 'List, validate, and scaffold executable procedures'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "graph" -d 'Inspect and validate knowledge_graph.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "cross-refs" -d 'Inspect and validate cross_refs.json'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "skills" -d 'Manage and validate the skills/ layer'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "l10n" -d 'Manage and validate the l10n/ localization layer'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "new" -d 'Scaffold + LLM-generate a complete pack in one command'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "generate" -d 'Run (or re-run) LLM generation on an existing pack'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "fix" -d 'Failure-aware chunk regeneration using eval results'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "fix-until" -d 'Iterative eval+fix loop until a pass-rate threshold is met'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "review" -d 'Generate evidence drafts for manual review gates'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "keygen" -d 'Generate an Ed25519 keypair for signing packs'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "sign" -d 'Sign a built archive with an Ed25519 private key'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "install" -d 'Install a pack from the registry'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "uninstall" -d 'Remove an installed pack'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "update" -d 'Re-resolve and update installed packs to satisfy lock-file constraints'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "publish" -d 'Publish a built and signed pack to the registry'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "yank" -d 'Mark a published version as yanked'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "deprecate" -d 'Mark a published version as deprecated (or clear a prior deprecation with --undo)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "registry" -d 'Registry account and pack management (login, logout, keys, access)'
complete -c dkp -n "__fish_dkp_using_subcommand help; and not __fish_seen_subcommand_from init info list validate search get inject export okf chunk eval prompt diff version build render-handbook release-check rights mcp-manifest serve tui webui run procedures graph cross-refs skills l10n new generate fix fix-until review keygen sign install uninstall update publish yank deprecate registry help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
