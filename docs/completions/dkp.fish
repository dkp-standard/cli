...
complete -c dkp -n "__fish_dkp_using_subcommand install" -l dest -d 'Install to a custom directory' -r -F
...
complete -c dkp -n "__fish_dkp_using_subcommand uninstall" -l dest -d 'Remove from a custom directory' -r -F
